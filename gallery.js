...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Gallery item click handler for lightbox effect
    galleryItems.forEach(item => {
    ...
    document.querySelectorAll('.gallery-item, .cta-content').forEach(el => {
        observer.observe(el);
    });
});

// Enhanced Lightbox functionality with zoom and scroll
